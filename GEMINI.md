...
* A fully functional and stable Java 21 application in the `./src-21` directory with 100% feature parity.
* The project must have **>90% unit test coverage**.
* Critical user journeys must be covered by **end-to-end integration tests**.
* All work committed to the `feature/java21-upgrade` branch.
